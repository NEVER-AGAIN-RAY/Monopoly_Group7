...
public final class SimulationWorker implements Callable<SimulationResult> {
    ...
    private final BiConsumer<String, GameStateSnapshot> resultSink;
    ...
    public SimulationWorker(
            ...
            int maxSnapshots,
            Duration maxRuntime) {
        this(sessionId, playerCount, broker, maxSnapshots, maxRuntime, null);
    }
    ...
    public SimulationWorker(
            ...
            int maxSnapshots,
            Duration maxRuntime,
            BiConsumer<String, GameStateSnapshot> resultSink) {
    ...
    public SimulationResult call() throws Exception {
        ...
        if (resultSink != null) {
            resultSink.accept(sessionId, snapshot);
        }
