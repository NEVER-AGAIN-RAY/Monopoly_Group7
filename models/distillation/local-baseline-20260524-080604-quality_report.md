...
## Quality Gates
- PASS `min_rows`: 4774 / 500 rows
- PASS `all_decision_kinds`: covered
- PASS `preferred_source_95pct`: local_heuristic 100.0%
- PASS `beats_first_candidate`: top1 0.827 vs first 0.337
- PASS `beats_random`: top1 0.827 vs random 0.213
...
## Metrics
- train: top1=0.823, mrr=0.901, first=0.345, random=0.216
- validation: top1=0.827, mrr=0.902, first=0.337, random=0.213

## Model Comparison
| Model | Validation Top1 | Validation MRR | First Baseline | Random Baseline |
|---|---:|---:|---:|---:|
| mlp | 0.827 | 0.902 | 0.337 | 0.213 |
| linear | 0.659 | 0.790 | 0.337 | 0.213 |
| knn | 0.393 | 0.578 | 0.337 | 0.213 |

## Gameplay Evaluation
| Opponent | Games | Natural Win Rate | Avg Snapshots | Avg Ranker Board Rank | Board Lead Rate | End Reasons |
|---|---:|---:|---:|---:|---:|---|
| hard | 12 | 1.000 | 204.9 | 2.17 | 0.333 | {'NATURAL_OR_LIMIT': 12} |
