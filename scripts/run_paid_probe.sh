...
TRACE="${1:-$ROOT/data/distillation/deepseek-probe-$STAMP.jsonl}"
OUT_PREFIX="${2:-$ROOT/models/distillation/deepseek-probe-$STAMP}"
...
python3 scripts/audit_distillation_trace.py "$TRACE" \
